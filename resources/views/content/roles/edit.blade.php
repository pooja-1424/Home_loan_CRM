                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check mt-3">
                                    @foreach($permission as $pkey=>$value)
                                        <input class="form-check-input" type="checkbox" name="permission[]" value="{{ $value->id }}" id="defaultCheck" @php echo in_array($value->id, $rolePermissions) ? "checked" : "" @endphp />
                                        <label class="form-check-label perm_label" for="defaultCheck{{ $value->id }}">
                                        {{ $value->name }}
                                        </label>
                                    <br/>
                                    @endforeach
